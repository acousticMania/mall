...
<body>
    <div class="container">
        ...
        <div title="버튼영역"  align="center">
        	<span><input style='margin-right: 10px;' class="btn btn-lg btn-success" type="button" value="저장"   ${codeInfo.editMode=="add"?"onclick='addGrpCode();'":"onclick='editGrpCode();'"}   ></span><span><input style="margin-right: 10px;" class="btn btn-lg btn-success"  type="button" value="취소" onclick="closePop()"></span>
