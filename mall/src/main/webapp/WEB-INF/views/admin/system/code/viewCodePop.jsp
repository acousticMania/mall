                    ...
                    <div class="panel-body">
                        <form role="form" id="form" name="form">
                            ...
                            <div title="버튼영역"  align="center">
					        	<span><input style="margin-right: 10px;" class="btn btn-lg btn-success" type="button" value="수정" id="edit" onclick="editCodePop();" ></span><span><input class="btn btn-lg btn-success" style="margin-right: 10px;"  type="button" value="취소" onclick="closePop()"></span>
							</div>
                        </form>
                    </div>
                </div>
