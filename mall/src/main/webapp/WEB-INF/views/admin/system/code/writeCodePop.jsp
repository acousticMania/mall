    ...
    /*  $(document).ready(function() {
	    $('#form').validate({
	        ...
	        submitHandler: function () {
	            var form = $("#form")[0];
	        	form.action = "/admin/system/code/addCode";
	        	form.method = "post";
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" id="cd_sys_id" name="cd_sys_id" value="${codeInfo.cd_sys_id}">
                            <table class="table">
                            	...
                            	<tr>
                            		<td>코드</td>
                            		<td><input style="width: 99%;" type="text" id="cd" name="cd" ${codeInfo.editMode=="add"?"":"disabled='disabled'"} value="${codeInfo.cd}"></td>
                            	</tr>
                            	<tr>
                            		<td>코드명</td>
                            		<td><input style="width: 99%;" type="text" id="cd_name" name="cd_name" value="${codeInfo.cd_name}"></td>
                            	</tr>
                            	<tr>
                            		<td>설명</td>
